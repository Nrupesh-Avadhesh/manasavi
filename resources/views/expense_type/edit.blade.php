<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('App\Http\Controllers\ExpenseTypeController@update', [$expense_type->id]),
        'method' => 'PUT', 'id' => 'company_edit_form', 'class' => 'form-horizontal my_new_he', 'enctype' => 'multipart/form-data' ]) !!}
            <div class="modal-body">
                
                <div class="form-group">
                    <label class="form-label">Name: <span class="text-danger">*</span></label>
                    <input type="text" name="name" class="form-control" value="{{ $expense_type->name }}" placeholder="Enter Name">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="description" class="form-control" value="{{ $expense_type->description }}" placeholder="Description">
