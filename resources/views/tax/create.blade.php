<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('App\Http\Controllers\TaxController@store'), 'method' => 'post','files'=>true, 'id' => 'company_add_form', 'class' => 'form-horizontal my_new_he' ,'enctype' => 'multipart/form-data']) !!}
            ...
            {{-- <form action=""> --}}
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="percentage" class="form-control" step="0.01" min="0.00" placeholder="Enter Percentage">
