            ...
            <div class="card bg-c-white text-black">
                <div class="card-block table-responsive mb-2">
                    <h4 class="flex-row-reverse justify-content-between m-0 row w-100">
                        <button class="add btn f-right cus_form_open_btn" data-href="{{ action('App\Http\Controllers\ExpenseController@create') }}" data-bs-toggle="offcanvas" role="button" data-container=".company_add_modal" aria-controls="offcanvasExampleadd">
        ...
        $(document).ready(function() {
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: function(data){
                        if(data.is_bill == 'Yes'){
                            return '<img src="'+data.img+'/uploads/bill/'+data.bill_img+'"style="max-width: 100px;max-height: 100px;">';
                        } else {
                            return '';
                        }
                    }, name: 'bill_img'},
                    {data: 'name' , name: 'name'},
                    {data: function(data){ return data.expense_type.name; }, name: 'expense_type.name'},
