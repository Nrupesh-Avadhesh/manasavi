<div class="modal-dialog  modal-lg" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('App\Http\Controllers\ExpenseController@update', [$expense->id]), 'method' => 'PUT', 'id' => 'company_edit_form', 'class' => 'form-horizontal my_new_he', 'enctype' => 'multipart/form-data' ]) !!}
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label">Expense Type: <span class="text-danger">*</span></label>
                            {!! Form::select('expense_type_id',$expense_type ,$expense->expense_type_id, ['class' => 'form-control js-example-basic-single','placeholder' => 'Select Expense Type']); !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="test" name="name" value="{{ $expense->name }}" class="form-control" placeholder="Enter Name.">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="description" value="{{ $expense->description }}" class="form-control" placeholder="Enter Description">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="date" value="{{ $expense->date }}" class="form-control" value="{{ date('Y-m-d') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="amount" value="{{ $expense->amount }}" class="form-control" min="0" step="0.01" placeholder="Enter Amount">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div>
                                <label class="mx-2">
                                    <input type="radio" name="is_bill" class="mr-1 is_bill" value="Yes" @if($expense->is_bill == 'Yes') checked @endif>Yes
                                </label>
                                <label class="mx-2">
                                    <input type="radio" name="is_bill" class="mr-1 is_bill" value="No" @if($expense->is_bill == 'No') checked @endif>No
                                </label>
                            </div>
