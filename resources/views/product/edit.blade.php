<div class="modal-dialog " role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('App\Http\Controllers\ProductController@update', [$product->id]), 'method' => 'PUT', 'id' => 'company_edit_form', 'class' => 'form-horizontal my_new_he', 'enctype' => 'multipart/form-data' ]) !!}
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="form-label">Measures: <span class="text-danger">*</span></label>
                            {!! Form::select('measure_id',$measures , $product->measure_id, ['class' => 'form-control js-example-basic-single','placeholder' => 'Select Measures']); !!}
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="HSN_code" value="{{ $product->HSN_code }}" class="form-control" placeholder="Enter HSN Code.">
