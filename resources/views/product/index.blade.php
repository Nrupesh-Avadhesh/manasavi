            ...
            <div class="card bg-c-white text-black">
                <div class="card-block table-responsive mb-2">
                    <h4 class="flex-row-reverse justify-content-between m-0 row w-100">
                        <button class="add btn f-right cus_form_open_btn" data-href="{{ action('App\Http\Controllers\ProductController@create') }}" data-bs-toggle="offcanvas" role="button" data-container=".company_add_modal" aria-controls="offcanvasExampleadd">
