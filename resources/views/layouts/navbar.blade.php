<nav class="navbar header-navbar pcoded-header">
    <div class="navbar-wrapper">
        ...
        <div class="justify-content-between navbar-logo">
            ...
            <a href="{{url('/dashboard')}}" style=" display: inline-block; max-width: 150px; max-height: 56px; ">
                        ...
                        <ul class="show-notification profile-notification dropdown-menu" data-dropdown-in="fadeIn"
                            ...
                            <li>
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <a href="{{ url('/logout') }}" onclick="event.preventDefault(); this.closest('form').submit();"><i class="feather icon-log-out"></i> Logout </a>
                                </form>
                            </li>
                        </ul>
