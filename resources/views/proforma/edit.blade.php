<div class="modal-dialog modal-invoice-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Proforma</h5>

            <button type="button" class="close close_cus" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        {!! Form::open(['url' => action('App\Http\Controllers\ProformaController@update', [$proforma->id]), 'method' => 'PUT', 'id' => 'company_edit_form', 'class' => 'form-horizontal my_new_he', 'enctype' => 'multipart/form-data' ]) !!}
            <div class="modal-body form_g_mb_0">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            <label class="form-label">Company: <span class="text-danger">*</span></label>
                            {!! Form::select('companie_id',$company ,$proforma->companie_id, ['class' => 'form-control js-example-basic-single companie_data_'.$re_no,'placeholder' => 'Select Company']); !!}
                        ...
                        <div class="form-group">
                            ...
                            <select name="customer_id" class="form-control js-example-basic-single customer_{{ $re_no }} col-sm-12">
                                ...
                                @foreach ($customer as $val2)
                                    <option value="{{ $val2->id }}" @if($proforma->customer_id == $val2->id) selected @endif>{{ $val2->company_name }} - {{ $val2->first_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            {!! Form::select('bank_id', $bank, $proforma->bank_id, ['class' => 'form-control  bank_data_'.$re_no,'placeholder' => 'Select Bank']); !!}
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $proforma->proforma_no }}" placeholder="Enter Proforma No." readonly>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            <label class="form-label">E Way Bill No: </label>
                            <input type="text" name="e_way_bill_no" value="{{ $proforma->e_way_bill_no }}" class="form-control" placeholder="Enter E Way Bill No.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="date" name="date" class="form-control" value="{{ $proforma->date }}">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="delivery_note" class="form-control" value="{{ $proforma->delivery_note }}" placeholder="Enter Delivery Note.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            {!! Form::select('payment_mode_id', $payment, $proforma->payment_mode_id, ['class' => 'form-control js-example-basic-single','placeholder' => 'Select Payment Mode']); !!}
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="reference_no" value="{{ $proforma->reference_no }}" class="form-control" placeholder="Enter Reference No.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="other_reference_no" value="{{ $proforma->other_reference_no }}" class="form-control" placeholder="Enter Other Reference No.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="buyers_order_no" value="{{ $proforma->buyers_order_no }}" class="form-control" placeholder="Enter Buyers Order No.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="date" name="dated" value="{{ $proforma->dated }}" class="form-control">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="dispatch_doc_no" value="{{ $proforma->dispatch_doc_no }}" class="form-control" placeholder="Enter Dispatch Doc No.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="date" name="delivery_note_date" value="{{ $proforma->delivery_note_date }}" class="form-control">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="dispatched_through" value="{{ $proforma->dispatched_through }}" class="form-control" placeholder="Enter Dispatched Through.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="destination" value="{{ $proforma->destination }}" class="form-control" placeholder="Enter Destination.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="date" name="bill_of_lading" value="{{ $proforma->bill_of_lading }}" class="form-control">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="vehicle_no" value="{{ $proforma->vehicle_no }}" class="form-control" placeholder="Enter Vehicle No.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            {!! Form::select('status', ['Pending' => 'Pending', 'Approved' => 'Approved', 'Rejected' => 'Rejected'] , $proforma->status, ['class' => 'form-control js-example-basic-single']); !!}
                        ...
                        <div class="table-padding table-responsive">
                            <table class="table table-bordered text-left">
                                ...
                                <tbody class="product_list_{{ $re_no }}">
                                    ...
                                    @foreach ($proforma->proforma_detal as $key=>$val)
                                        <tr class="row_{{$key+1}}_{{$re_no}}">
                                            ...
                                            <td>
                                                <select name="product_id[]" class=" proforma_id_{{$re_no}} proforma_id_{{$re_no}}_{{$key+1}} col-sm-12" data-row="{{$key+1}}" required>
                                                ...
                                                <td style="text-align: center;"><input type="number" name="qty[]" style="text-align: right;" value="{{ $val->quantity }}" min="0" required step="0.001" data-row="{{$key+1}}" class="qty_{{$key+1}}_{{$re_no}} qty_{{$re_no}}" ></td>
                                ...
                                <tfoot >
                                    ...
                                    @foreach ($proforma->proforma_tax as $taxkey=> $tax_val)
                                    ...
                                    <tr class="tax_list_{{ $re_no }}">
                                        ...
                                        <td><input type="text" style="font-weight: bold; text-align: right !important;" name="round" class="round_{{ $re_no }}" value="{{ $proforma->round }}"  readonly></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th style="text-align: right !important;"></th>
                                        <th style="text-align: right !important;">₹</th>
                                        <td><input type="number" style="font-weight: bold; text-align: right !important;" name="gtotal" class="gtotal_{{ $re_no }}" value="{{ $proforma->total_amount }}" step="0.01" readonly></td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
                    ...
                    <div class="col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            <textarea name="word_amount" class="form-control word_amount_{{ $re_no }}" placeholder="Amount in words" cols="30" rows="3" readonly>{{ $proforma->word_amount }}</textarea>
                    ...
                    <div class="col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            <textarea name="terms_of_delivery" class="form-control terms_of_delivery_{{ $re_no }}" placeholder="Enter Terms of Delivery" cols="30" rows="3" onInput="handleInput(event)">{!! $proforma->terms_of_delivery !!}</textarea>
