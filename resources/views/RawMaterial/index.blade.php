...
@section('header_titel', 'Raw Material')
            ...
            <div class="card bg-c-white text-black">
                <div class="card-block table-responsive mb-2">
                    <h4 class="flex-row-reverse justify-content-between m-0 row w-100">
                        <button class="add btn f-right cus_form_open_btn" data-href="{{ action('App\Http\Controllers\RawMaterialController@create') }}"
        ...
        $(document).ready(function() {
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'name' , name: 'name'},
                    {data: function(data){ return data.measures.name; }, name: 'measures.name'},
                    {data: 'description', name: 'description'},
                    {data: 'HSN_code', name: 'HSN_code'},
                    // {data: 'add_vendor', name: 'add_vendor'},
                    {data: function(data){
                        if(data.status == 'Active'){
                            return data.add_vendor;
                        }else{
                            return '';
                        }
                    }, name: 'add_vendor'},
