<div class="modal-dialog " role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('App\Http\Controllers\RawMaterialController@store'), 'method' => 'post','files'=>true, 'id' => 'company_add_form', 'class' => 'form-horizontal my_new_he' ,'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="vendors[]" class="js-example-basic-multiple col-sm-12" multiple>
                                @foreach ($vendor as $val2)
