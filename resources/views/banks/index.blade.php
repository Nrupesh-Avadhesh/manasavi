            ...
            <div class="card bg-c-white text-black">
                <div class="card-block table-responsive mb-2">
                    <h4 class="flex-row-reverse justify-content-between m-0 row w-100">
                        <button class="add btn f-right cus_form_open_btn" data-href="{{ action('App\Http\Controllers\BanksController@create') }}"
        ...
        $(document).ready(function() {
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'IFS_Code' , name: 'IFS_Code'},
                    {data: 'AC_Holder_Name' , name: 'AC_Holder_Name'},
                    {data: function(data){
