<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('App\Http\Controllers\CompanyController@store'), 'method' => 'post','files'=>true, 'id' => 'company_add_form', 'class' => 'form-horizontal my_new_he' ,'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="pan_card_no" class="form-control" placeholder="Enter Pan No.">
                    ...
                    {{-- <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="declaration" class="form-control" cols="30" rows="5"></textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="terms" class="form-control" cols="30" rows="5"></textarea>
