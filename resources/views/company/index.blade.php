            ...
            <div class="card bg-c-white text-black">
                <div class="card-block table-responsive mb-2">
                    <h4 class="flex-row-reverse justify-content-between m-0 row w-100">
                        <button class="add btn f-right cus_form_open_btn" data-href="{{ action('App\Http\Controllers\CompanyController@create') }}"
        ...
        $(document).ready(function() {
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: function(data){
                        return '<img src="'+data.img+'/uploads/logo/'+data.logo+'"style=" width: 150px; ">';
                    }, name: 'logo'},
                    {data: 'name' , name: 'name'},
                    {data: 'phone' , name: 'phone'},
                    {data: 'email' , name: 'email'},
                    {data: 'pan_card_no' , name: 'pan_card_no'},
                    {data: 'GST' , name: 'GST'},
                    {data: function(data){
