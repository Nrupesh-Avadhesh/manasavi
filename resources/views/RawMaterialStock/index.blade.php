@extends('layouts.app')
@section('title', ' / Raw Material Stock')
@section('header_titel', 'Raw Material Stock')
@section('sub_page', 'Raw Material Stock')
@section('header_link')
@endsection
@section('content')
            ...
            <div class="card bg-c-white text-black">
                <div class="card-block table-responsive mb-2">
                    <h4 class="flex-row-reverse justify-content-between m-0 row w-100">
                        <button class="add btn f-right cus_form_open_btn" data-href="{{ action('App\Http\Controllers\RawMaterialStockController@create') }}" data-bs-toggle="offcanvas" role="button" data-container=".company_add_modal" aria-controls="offcanvasExampleadd">
        ...
        $(document).ready(function() {
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: function(data){ return data.vendor.company_name+' / '+data.vendor.first_name; }, name: 'vendor.first_name'},
                    {data: 'date', name: 'date'},
                    {data: 'vehicle_no', name: 'vehicle_no'},
                    {data: 'total_proposs_amount', name: 'total_proposs_amount'},
