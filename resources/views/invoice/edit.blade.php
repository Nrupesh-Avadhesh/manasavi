<div class="modal-dialog modal-invoice-lg" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('App\Http\Controllers\InvoiceController@update', [$invoice->id]), 'method' => 'PUT', 'id' => 'company_edit_form', 'class' => 'form-horizontal my_new_he', 'enctype' => 'multipart/form-data' ]) !!}
            <div class="modal-body form_g_mb_0">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            <label class="form-label">Company: <span class="text-danger">*</span></label>
                            {!! Form::select('companie_id',$company ,$invoice->companie_id, ['class' => 'form-control js-example-basic-single companie_data_'.$re_no,'placeholder' => 'Select Company']); !!}
                        ...
                        <div class="form-group">
                            ...
                            <select name="customer_id" class="form-control js-example-basic-single customer_{{ $re_no }} col-sm-12">
                                ...
                                @foreach ($customer as $val2)
                                    <option value="{{ $val2->id }}" @if($invoice->customer_id == $val2->id) selected @endif>{{ $val2->company_name }} - {{ $val2->first_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            {!! Form::select('bank_id', $bank, $invoice->bank_id, ['class' => 'form-control  bank_data_'.$re_no,'placeholder' => 'Select Bank']); !!}
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $invoice->invoice_no }}" placeholder="Enter Invoice No." readonly>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            <label class="form-label">E Way Bill No: </label>
                            <input type="text" name="e_way_bill_no" value="{{ $invoice->e_way_bill_no }}" class="form-control" placeholder="Enter E Way Bill No.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="delivery_note" class="form-control" value="{{ $invoice->delivery_note }}" placeholder="Enter Delivery Note.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            {!! Form::select('payment_mode_id', $payment, $invoice->payment_mode_id, ['class' => 'form-control js-example-basic-single','placeholder' => 'Select Payment Mode']); !!}
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="reference_no" value="{{ $invoice->reference_no }}" class="form-control" placeholder="Enter Reference No.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="other_reference_no" value="{{ $invoice->other_reference_no }}" class="form-control" placeholder="Enter Other Reference No.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="buyers_order_no" value="{{ $invoice->buyers_order_no }}" class="form-control" placeholder="Enter Buyers Order No.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="date" name="dated" value="{{ $invoice->dated }}" class="form-control">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="dispatch_doc_no" value="{{ $invoice->dispatch_doc_no }}" class="form-control" placeholder="Enter Dispatch Doc No.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="date" name="delivery_note_date" value="{{ $invoice->delivery_note_date }}" class="form-control">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="dispatched_through" value="{{ $invoice->dispatched_through }}" class="form-control" placeholder="Enter Dispatched Through.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="destination" value="{{ $invoice->destination }}" class="form-control" placeholder="Enter Destination.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group">
                            ...
                            <input type="date" name="bill_of_lading" value="{{ $invoice->bill_of_lading }}" class="form-control">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="vehicle_no" value="{{ $invoice->vehicle_no }}" class="form-control" placeholder="Enter Vehicle No.">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            {!! Form::select('status', ['Pending' => 'Pending', 'Approved' => 'Approved', 'Rejected' => 'Rejected'] , $invoice->status, ['class' => 'form-control js-example-basic-single']); !!}
                        ...
                        <div class="table-padding table-responsive">
                            <table class="table table-bordered text-left">
                                ...
                                <tbody class="product_list_{{ $re_no }}">
                                    @php 
                                        $no_of_tax_row = $countRow = 1;
                                        $amount = 0.00;
                                        $quantity = 0;
                                    @endphp
                                    @foreach ($invoice->invoice_detal as $key=>$val)
                                        <tr class="row_{{$key+1}}_{{$re_no}}">
                                            <td style="text-align: center;">{{$key+1}}</td>
                                            <td style="text-align: center;"><input type="text" name="container_no[]" value="{{ $val->container_no }}" class="container_no_{{$re_no}}"></td>
                                            <td style="text-align: center;"><input type="text" name="no_and_kind_of_pkgs[]" value="{{ $val->no_and_kind_of_pkgs }}" class="no_and_kind_of_pkgs_{{$re_no}}"></td>
                                            <td>
                                                <select name="product_id[]" class=" product_id_{{$re_no}} product_id_{{$re_no}}_{{$key+1}} col-sm-12" data-row="{{$key+1}}" required>
                                                    <option value="" data-hsn="">Select Product</option>
                                                    @foreach ($product as $valu)
                                                        <option value="{{ $valu->id }}" @if($valu->id == $val->product_id) selected @endif data-hsn="{{ $valu->HSN_code }}">{{ $valu->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td style="text-align: center;"><input type="text" name="hsn[]"  class="hsn_{{$key+1}}_{{$re_no}}" value="{{ $val->HSN_code }}" readonly></td>
                                                <td style="text-align: center;"><input type="number" name="qty[]" style="text-align: right;" value="{{ $val->quantity }}" min="0.001" required step="1" data-row="{{$key+1}}" class="qty_{{$key+1}}_{{$re_no}} qty_{{$re_no}}" ></td>
                                                <td style="text-align: center;"><input type="number" name="rate[]" style="text-align: right;" value="{{ $val->rate }}" min="0" step="0.01" data-row="{{$key+1}}" required class="rate_{{$key+1}}_{{$re_no}} rate_{{$re_no}}" ></td>
                                                <td style="text-align: center;"><input type="text" name="per[]" style="text-align: right;" value="{{ $val->per }}" value="Mtr" required class="pre_{{$key+1}}_{{$re_no}}" ></td>
                                                <td style="text-align: center;"><input type="number" name="Amo[]" style="text-align: right;" value="{{ number_format((float)$val->amount, 2, '.', '') }}" required data-row="{{$key+1}}" class="Amo_{{$key+1}}_{{$re_no}} Amo_{{$re_no}}" readonly></td>
                                                <td><span class="add btn f-right remove_product_{{$re_no}}" data-row="{{$key+1}}" role="button"  aria-controls="offcanvasExampleadd"> <i class="fa fa-trash"></i> </span></td>
                                            </tr>
                                        @php 
                                            $countRow += $key+1;
                                        ...
                                        @endphp
                                    @endforeach
                                    <input type="hidden" class="no_of_row" value="{{ $countRow }}">
                                </tbody>
                                <tfoot >
                                    <tr >
                                        <th style="text-align: right !important;" colspan="5"> Total</th>
                                        <td><input type="number" style="font-weight: bold; text-align: right !important;" name="gqty" value="{{ $quantity }}" class="gqty_{{ $re_no }}" value="0" readonly></td>
                                        <th style="text-align: right !important;"></th>
                                        <th style="text-align: right !important;">₹</th>
                                        <td><input type="number" style="font-weight: bold; text-align: right !important;" name="gproA" class="gproA_{{ $re_no }}" value="{{ $amount }}" step="0.01" readonly></td>
                                    ...
                                    @foreach ($invoice->invoice_tax as $taxkey=> $tax_val)
                                        @php $selected_percentage = 0;@endphp
                                        <tr class="tax_row_{{ $no_of_tax_row }}_{{ $re_no }}">
                                            ...
                                            <td>
                                                <select name="tax_id[]" class=" tax_id_{{ $re_no }} tax_id_{{ $re_no }}_{{ $no_of_tax_row }} col-sm-12" data-row="{{ $no_of_tax_row }}" required>
                                                    ...
                                                    @foreach ($tax as $tax_d)
                                                        <option value="{{ $tax_d->id }}" @if($tax_d->id == $tax_val->tax_id) selected @php $selected_percentage = $tax_d->percentage; @endphp @endif data-percentage="{{ $tax_d->percentage }}" >{{ $tax_d->name }} - {{ $tax_d->percentage }} %</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                            <td style="text-align: center;"><input type="text" name="percentage[]" value="{{ $selected_percentage }}" class="percentage_{{ $re_no }} percentage_{{ $re_no }}_{{ $no_of_tax_row }}" data-row="{{ $no_of_tax_row }}" readonly></td>
                                            <td style="text-align: center;"><input type="number" name="tax_a[]" value="{{ number_format((float)$tax_val->amount, 2, '.', '') }}" style="text-align: right;" required class="tax_a_{{ $re_no }} tax_a_{{ $re_no }}_{{ $no_of_tax_row }}" step="0.01" data-row="{{ $no_of_tax_row }}" readonly></td>
                                        ...
                                        @php  $no_of_tax_row += $taxkey+1; @endphp
                                    @endforeach
                                    <input type="hidden" class="no_of_tax_row" value="{{ $no_of_tax_row }}">
                                    <tr class="tax_list_{{ $re_no }}">
                                        <th style="text-align: right !important;" colspan="8">Round of</th>
                                        <td><input type="text" style="font-weight: bold; text-align: right !important;" name="round" class="round_{{ $re_no }}" value="{{ $invoice->round }}"  readonly></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th style="text-align: right !important;"></th>
                                        <th style="text-align: right !important;">₹</th>
                                        <td><input type="number" style="font-weight: bold; text-align: right !important;" name="gtotal" class="gtotal_{{ $re_no }}" value="{{ $invoice->total_amount }}" step="0.01" readonly></td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
                    ...
                    <div class="col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            <textarea name="word_amount" class="form-control word_amount_{{ $re_no }}" placeholder="Amount in words" cols="30" rows="3" readonly>{{ $invoice->word_amount }}</textarea>
                    ...
                    <div class="col-sm-6 col-12 mb-2">
                        <div class="form-group">
                            ...
                            <textarea name="terms_of_delivery" class="form-control terms_of_delivery_{{ $re_no }}" placeholder="Enter Terms of Delivery" cols="30" rows="3" onInput="handleInput(event)">{!! $invoice->terms_of_delivery !!}</textarea>
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '.product_id_'+re_no, function(e) {
            row = $(this).data('row');
            hsn = $('.product_id_'+re_no+'_'+row+' option:selected').data('hsn');
            $( '.hsn_'+row +'_'+re_no ).val(hsn);
        });
        $(document).on('click', '.add_product_'+re_no, function(e) {
            $.ajax({
                type:'post',
                url:'invoice/product_list',
                ...
                success: function(result) {
                    if(result.length == 0){
                        ...
                        html += '<tr class="row_'+no_of_row +'_'+re_no+'">'
                            ...
                            +'<td><select name="product_id[]" class=" product_id_'+re_no+' product_id_'+re_no+'_'+no_of_row+' col-sm-12" data-row="'+no_of_row+'" required>'
                                +'<option value="" data-hsn="">Select Product</option>';
                                $.each(result, function( index, data ) {
        ...
        var no_of_tax_row = $('.no_of_tax_row').val();
